...
def test_stats_by_date_valid(sample_reviews):
    ...
    assert data["data"][0]["total_count"] == 1  # total until 2026-06-01: 1
    assert data["data"][1]["date"] == "2026-06-02"
    assert data["data"][1]["count"] == 0  # 0 valid on 2026-06-02 for main branch
    assert data["data"][1]["total_count"] == 1  # total until 2026-06-02: 1
...
def test_stats_by_date_total(sample_reviews):
    ...
    assert data["data"][0]["total_count"] == 2  # total until 2026-06-01: 2
    assert data["data"][1]["date"] == "2026-06-02"
    assert data["data"][1]["count"] == 1  # 1 total on 2026-06-02 for main
    assert data["data"][1]["total_count"] == 3  # total until 2026-06-02: 2+1=3
...
def test_stats_by_date_accept_rate(sample_reviews):
    ...
    assert data["data"][0]["total_accept_rate"] == 0.5  # total until 2026-06-01: 1/(1+1) = 0.5
