...
- Qwen3.5-35B: lightweight model. Use for simple greetings, translation, formatting, daily conversation, and other basic tasks.

Return only one model name, with no explanation or extra text.
Available models: [glm-5, DeepSeek-V4-Flash, Qwen3.5-35B]
